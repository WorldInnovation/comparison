 ...
 */
package es.fs.fscomparisonaddon.jalo;
...
/**
 * This is the extension manager of the Fscomparisonaddon extension.
 */
public class FscomparisonaddonManager extends GeneratedFscomparisonaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FscomparisonaddonManager.class.getName());
	 ...
	 */
	public static FscomparisonaddonManager getInstance()
	{
		return (FscomparisonaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FscomparisonaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FscomparisonaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FscomparisonaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FscomparisonaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FscomparisonaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
