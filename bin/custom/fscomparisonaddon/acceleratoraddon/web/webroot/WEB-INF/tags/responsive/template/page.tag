...
<%@ taglib prefix="common" tagdir="/WEB-INF/tags/addons/fscomparisonaddon/responsive/common"%>--%>
<%--<%@ taglib prefix="cart" tagdir="/WEB-INF/tags/addons/fscomparisonaddon/responsive/cart" %>--%>
